...
:wq
```
To simply write changes you can enter **w**, to quit if you have not made any changes you can enter **q** and to quit and discard any changes you may have made: enter **q!**  
